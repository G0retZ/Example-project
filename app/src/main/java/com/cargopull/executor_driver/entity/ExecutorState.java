...
public enum ExecutorState {
  ...
  /**
   * Водитель "принимает срочный заказ на выполнение". В этом состоянии водитель принимает решение по полученному заказу.
   */
  DRIVER_ORDER_CONFIRMATION,

  /**
   * Водитель "принимает предзаказ на выполнение". В этом состоянии водитель принимает решение по полученному заказу.
   */
