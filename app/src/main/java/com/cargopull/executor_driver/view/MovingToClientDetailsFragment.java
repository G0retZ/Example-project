...
public class MovingToClientDetailsFragment extends BaseFragment implements OrderViewActions {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    View view = inflater.inflate(R.layout.fragment_moving_to_client_details, container, false);
