...
public class OrderCostDetailsRouteFragment extends BaseFragment implements OrderRouteViewActions {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    View view = inflater.inflate(R.layout.fragment_order_cost_details_route, container, false);
    recyclerView = view.findViewById(R.id.recyclerView);
    recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
    recyclerView.setAdapter(new OrderCostDetailsRouteAdapter(new ArrayList<>()));
    return view;
  }
  ...
  public void setRoutePointItems(@NonNull List<RoutePointItem> routePointItems) {
    OrderCostDetailsRouteAdapter adapter = new OrderCostDetailsRouteAdapter(routePointItems);
