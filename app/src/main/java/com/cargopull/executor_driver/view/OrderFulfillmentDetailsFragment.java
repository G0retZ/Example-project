...
public class OrderFulfillmentDetailsFragment extends BaseFragment implements OrderViewActions {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    View view = inflater.inflate(R.layout.fragment_order_fulfillment_details, container, false);
