...
class WaitingForClientRouteAdapter extends
    RecyclerView.Adapter<WaitingForClientRouteAdapter.RoutePointViewHolder> {

  @NonNull
  private final List<RoutePointItem> routePointItems;

  WaitingForClientRouteAdapter(@NonNull List<RoutePointItem> routePointItems) {
  ...
  public int getItemViewType(int position) {
    return routePointItems.get(position).isProcessed()
        ? R.layout.fragment_waiting_for_client_route_point_item_processed
        : R.layout.fragment_waiting_for_client_route_point_item;
  }

  @NonNull
  @Override
  public WaitingForClientRouteAdapter.RoutePointViewHolder onCreateViewHolder(
  ...
  @Override
  public void onBindViewHolder(@NonNull WaitingForClientRouteAdapter.RoutePointViewHolder holder,
      int position) {
