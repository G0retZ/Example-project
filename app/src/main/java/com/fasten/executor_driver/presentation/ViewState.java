...
/**
 * Состояние, которое применяется к View используя предоставленные действия.
 * Может быть использован как для восстановления последнего состояния, так и для разностных изменений
 *
