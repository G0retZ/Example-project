...
public interface OrderConfirmationViewActions {
   ...
   */
  void showOrderConfirmationPending(boolean pending);
   ...
   */
  void showOrderConfirmationAvailabilityError(boolean show);
   ...
   * @param show - показать или нет?
   */
  void showOrderConfirmationNetworkErrorMessage(boolean show);
