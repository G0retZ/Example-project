...
public class SelectedPreOrderConfirmationViewModelTest extends OrderConfirmationViewModelTest {

  public SelectedPreOrderConfirmationViewModelTest(ExecutorState conditions) {
    super(conditions);
  }
  ...
  public OrderConfirmationViewModel getViewModel(ErrorReporter errorReporter,
    ...
    return new SelectedPreOrderConfirmationViewModel(errorReporter, sUseCase, useCase, shakeItPlayer, ringTonePlayer, timeUtils, eventLogger);
  }
}