...
public class ApiOrderRule extends CommonTestRule {
  ...
  public String getFullOrder() {
    return OBJECT_START
        ...
        + String.format(OVER_PACKAGE_TIMER, 423401L) + FIELD_DIVIDER
        + String.format(OVER_PACKAGE_PERIOD, 93212L) + FIELD_DIVIDER
  ...
  @NonNull
  public String getOrderWithoutEstimation() {
    return OBJECT_START
        + String.format(ORDER_ID, 7) + FIELD_DIVIDER
        + String.format(ORDER_COMMENT, "some comment") + FIELD_DIVIDER
        + String.format(ORDER_TOTAL_COST, 10_352) + FIELD_DIVIDER
  ...
  @NonNull
  public String getOrderWithoutOverPackageTimer() {
    return OBJECT_START
        + String.format(ORDER_ID, 7) + FIELD_DIVIDER
        + String.format(ORDER_COMMENT, "some comment") + FIELD_DIVIDER
        + String.format(ORDER_ESTIMATED, "over 9999 BTC") + FIELD_DIVIDER
  ...
  @NonNull
  public String getOrderWithoutOverPackagePeriod() {
    return OBJECT_START
        + String.format(ORDER_ID, 7) + FIELD_DIVIDER
        + String.format(ORDER_COMMENT, "some comment") + FIELD_DIVIDER
        + String.format(ORDER_ESTIMATED, "over 9999 BTC") + FIELD_DIVIDER
