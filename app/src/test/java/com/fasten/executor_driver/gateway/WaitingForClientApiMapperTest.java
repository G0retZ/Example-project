...
public class WaitingForClientApiMapperTest {
  ...
  /**
   * Должен успешно преобразовать JSON без маршрута.
   *
   * @throws Exception ошибка
   */
  @Test
  public void mappingJsonStringWithoutRouteToOrder() throws Exception {
    // Дано и Действие:
    Order order = mapper.map("{\n"
        + "    \"id\": \"7\",\n"
        + "    \"comment\": \"com\",\n"
  ...
  /**
   * Должен успешно преобразовать JSON с маршруом без точек.
   *
   * @throws Exception ошибка
   */
  @Test
  public void mappingJsonStringWithEmptyRouteToOrder() throws Exception {
    // Дано и Действие:
    Order order = mapper.map("{\n"
        + "    \"id\": \"7\",\n"
        + "    \"comment\": \"com\",\n"
  ...
  /**
   * Должен успешно преобразовать JSON с ETA = 0.
   *
   * @throws Exception ошибка
   */
  @Test
  public void mappingJsonStringWithZeroEtaToOrder() throws Exception {
    // Дано и Действие:
    Order order = mapper.map("{\n"
        + "    \"id\": \"7\",\n"
        + "    \"comment\": \"com\",\n"
  ...
  /**
   * Должен успешно преобразовать JSON с временем подтверждения = 0.
   *
   * @throws Exception ошибка
   */
  @Test
  public void mappingJsonStringWithZeroConfirmationTimeToOrder() throws Exception {
    // Дано и Действие:
    Order order = mapper.map("{\n"
        + "    \"id\": \"7\",\n"
        + "    \"comment\": \"com\",\n"
