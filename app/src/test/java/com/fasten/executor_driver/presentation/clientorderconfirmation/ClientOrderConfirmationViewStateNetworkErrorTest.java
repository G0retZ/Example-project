...
public class ClientOrderConfirmationViewStateNetworkErrorTest {

  private ClientOrderConfirmationViewStateNetworkError viewState;
  ...
  public void setUp() {
    ...
    viewState = new ClientOrderConfirmationViewStateNetworkError(orderItem);
  }
  ...
  public void testActions() {
    ...
    verify(clientOrderConfirmationViewActions).showNetworkErrorMessage(true);
  ...
  public void testNoActions() {
    // Дано:
    viewState = new ClientOrderConfirmationViewStateNetworkError(null);
