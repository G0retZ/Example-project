...
public class ClientOrderConfirmationViewStatePendingTest {

  private ClientOrderConfirmationViewStatePending viewState;
  ...
  public void setUp() {
    ...
    viewState = new ClientOrderConfirmationViewStatePending(orderItem);
  }
  ...
  public void testActions() {
    ...
    verify(clientOrderConfirmationViewActions).showClientOrderConfirmationPending(true);
  ...
  public void testNoActions() {
    // Дано:
    viewState = new ClientOrderConfirmationViewStatePending(null);
