...
public class MovingToClientViewStateNetworkErrorTest {

  private MovingToClientViewStateNetworkError viewState;
  ...
  public void setUp() {
    ...
    viewState = new MovingToClientViewStateNetworkError(routeItem);
  }
  ...
  public void testNoActions() {
    // Дано:
    viewState = new MovingToClientViewStateNetworkError(null);
