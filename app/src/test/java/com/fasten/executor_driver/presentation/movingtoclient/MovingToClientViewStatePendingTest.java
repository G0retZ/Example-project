...
public class MovingToClientViewStatePendingTest {
  ...
  private MovingToClientViewStatePending viewState;
  ...
  public void setUp() {
    ...
    viewState = new MovingToClientViewStatePending(routeItem);
  }
  ...
  public void testNoActions() {
    // Дано:
    viewState = new MovingToClientViewStatePending(null);
