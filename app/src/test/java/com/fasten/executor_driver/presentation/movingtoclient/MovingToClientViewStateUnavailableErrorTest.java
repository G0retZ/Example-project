...
public class MovingToClientViewStateUnavailableErrorTest {

  private MovingToClientViewStateUnavailableError viewState;
  ...
  public void setUp() {
    ...
    viewState = new MovingToClientViewStateUnavailableError(routeItem);
  }
  ...
  public void testActions() {
    ...
    verify(movingToClientViewActions).showOrderAvailabilityError(true);
  ...
  public void testNoActions() {
    // Дано:
    viewState = new MovingToClientViewStateUnavailableError(null);
