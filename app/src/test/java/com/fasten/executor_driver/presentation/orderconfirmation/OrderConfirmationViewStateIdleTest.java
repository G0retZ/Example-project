...
public class OrderConfirmationViewStateIdleTest {
  ...
  private OrderConfirmationViewStateIdle viewState;
  ...
  public void setUp() {
    ...
    viewState = new OrderConfirmationViewStateIdle(orderConfirmationItem);
  }
  ...
  public void testNoActions() {
    // Дано:
    viewState = new OrderConfirmationViewStateIdle(null);
