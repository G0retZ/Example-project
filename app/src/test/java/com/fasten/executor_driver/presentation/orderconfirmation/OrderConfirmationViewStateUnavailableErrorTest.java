...
public class OrderConfirmationViewStateUnavailableErrorTest {

  private OrderConfirmationViewStateUnavailableError viewState;
  ...
  public void setUp() {
    ...
    viewState = new OrderConfirmationViewStateUnavailableError(orderConfirmationItem);
  }
  ...
  public void testActions() {
    ...
    verify(orderConfirmationViewActions).showOrderConfirmationAvailabilityError(true);
  ...
  public void testNoActions() {
    // Дано:
    viewState = new OrderConfirmationViewStateUnavailableError(null);
