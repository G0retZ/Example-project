...
public class WaitingForClientViewStateNetworkErrorTest {

  private WaitingForClientViewStateNetworkError viewState;
  ...
  @Before
  public void setUp() {
    viewState = new WaitingForClientViewStateNetworkError(orderItem);
  }
  ...
  public void testNoActions() {
    // Дано:
    viewState = new WaitingForClientViewStateNetworkError(null);
