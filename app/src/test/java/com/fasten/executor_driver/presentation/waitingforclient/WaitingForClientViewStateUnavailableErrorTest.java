...
public class WaitingForClientViewStateUnavailableErrorTest {

  private WaitingForClientViewStateUnavailableError viewState;
  ...
  @Before
  public void setUp() {
    viewState = new WaitingForClientViewStateUnavailableError(orderItem);
  }
  ...
  public void testNoActions() {
    // Дано:
    viewState = new WaitingForClientViewStateUnavailableError(null);
